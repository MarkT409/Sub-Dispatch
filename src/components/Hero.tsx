    ...
    <section className="relative overflow-hidden pt-28 pb-20 md:pt-36 md:pb-28">
      ...
      <div className="relative mx-auto max-w-6xl px-6">
        ...
        <h1 className="font-display max-w-3xl text-4xl leading-[1.1] font-bold tracking-tight text-text-primary md:text-6xl">
          Homes. Businesses.{" "}
          <span className="text-amber-600 dark:text-amber-400">Built to code.</span>
        </h1>

        <p className="mt-6 max-w-xl text-lg leading-relaxed text-text-secondary">
          Residential, commercial, and underground electrical services—plus skilled
          rough-in and trim crews for contractors who need reliable labor on site.
        </p>
        ...
        <dl className="mt-16 grid grid-cols-3 gap-8 border-t border-border-strong pt-12 md:max-w-2xl">
          <div>
            <dt className="text-sm text-text-muted">Specialty</dt>
          ...
          <div>
            <dt className="text-sm text-text-muted">Market</dt>
            <dd className="mt-1 font-display text-lg font-semibold text-text-primary">
              Central Texas
            </dd>
          </div>
