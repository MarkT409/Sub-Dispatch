...
export function SyncSheetsButton({
  ...
  return (
    <button
      ...
      onClick={handleSync}
      disabled={busy}
      className="min-h-9 rounded-lg border border-border-default bg-bg-raised px-3 py-1.5 text-sm font-medium text-text-primary hover:border-amber-500/40 hover:text-amber-700 disabled:opacity-70 dark:hover:text-amber-400"
    >
